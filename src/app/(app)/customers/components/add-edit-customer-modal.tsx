  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => {
      ...
      <DialogContent className="sm:max-w-[550px]">
        ...
        {/* ScrollArea now wraps the Form and form tag */}
        <ScrollArea className="max-h-[60vh] pr-6"> 
          <Form {...form}>
            <form id="customer-form" onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 py-4">
              <FormField
        ...
        {/* DialogFooter is now a direct child of DialogContent, outside ScrollArea */}
        <DialogFooter className="pt-4 border-t">
          ...
          <Button form="customer-form" type="submit" disabled={isSaving}> {/* Explicitly link button to form */}
