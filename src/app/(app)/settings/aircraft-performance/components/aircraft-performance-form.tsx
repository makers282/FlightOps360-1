...
import { PlaneTakeoff as PerformanceIcon, Save, Copy } from 'lucide-react'; // Using PlaneTakeoff as PerformanceIcon
        ...
        {selectedAircraftId && (
          <Card className="shadow-md">
            <CardHeader>
              ...
              <CardDescription>Adjust the performance parameters below.</CardDescription>
            </CardHeader>
            ...
            <CardFooter>
              <Button type="submit">
                <Save className="mr-2 h-4 w-4" /> Save Performance Settings
              </Button>
            </CardFooter>
          </Card>
        )}
