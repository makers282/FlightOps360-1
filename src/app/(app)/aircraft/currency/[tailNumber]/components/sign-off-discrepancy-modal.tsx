      ...
      <DialogContent className="sm:max-w-lg flex flex-col max-h-[calc(100vh-8rem)]">
        ...
        <div className="flex-1 overflow-hidden"> {/* Wrapper for ScrollArea */}
          <ScrollArea className="h-full">
            <Form {...form}>
              {/* Padding moved to the form itself for content within ScrollArea */}
              <form id="sign-off-discrepancy-form" onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 px-4 py-2">
                <FormField
        ...
        <DialogFooter className="pt-4 border-t"> {/* Removed mt-2 */}
