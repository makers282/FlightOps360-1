...
import type { AircraftFilterOption } from '../page'; // Assuming this type is exported or defined in calendar page
...
interface CreateBlockOutEventModalProps {
  ...
  onSave: (data: BlockOutFormData) => void;
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Block out an aircraft for maintenance, owner use, or other reasons. This will appear on the calendar.
            (Note: This is a client-side visual block for now and not saved permanently.)
          </DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter className="pt-4">
          ...
          <Button type="submit" form="createBlockOutEventModalForm" onClick={form.handleSubmit(onSubmit)} disabled={isSaving || isLoadingAircraft}>
