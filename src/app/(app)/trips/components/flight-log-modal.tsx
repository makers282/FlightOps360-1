            ...
            <form id="flight-log-form" onSubmit={handleSubmit(onSubmitHandler)} className="space-y-6 p-1">
              ...
              <section className="space-y-4 p-4 border rounded-md shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-3">
                  <FormField control={control} name="taxiOutTimeMins" render={({ field }) => (<FormItem><FormLabel>Taxi-Out Time (mins)</FormLabel><FormControl><Input type="number" {...field} value={String(field.value ?? '')} onChange={e => field.onChange(parseInt(e.target.value, 10))} /></FormControl><FormMessage /></FormItem>)} />
                  ...
                  <FormField control={control} name="hobbsTakeOff" render={({ field }) => (<FormItem><FormLabel>Hobbs Take-Off</FormLabel><FormControl><Input type="number" step="0.1" {...field} value={String(field.value ?? '')} onChange={e => field.onChange(parseFloat(e.target.value))} /></FormControl><FormMessage /></FormItem>)} />
                  <FormField control={control} name="hobbsLanding" render={({ field }) => (<FormItem><FormLabel>Hobbs Landing</FormLabel><FormControl><Input type="number" step="0.1" {...field} value={String(field.value ?? '')} onChange={e => field.onChange(parseFloat(e.target.value))} /></FormControl><FormMessage /></FormItem>)} />
                  ...
                  <FormField control={control} name="taxiInTimeMins" render={({ field }) => (<FormItem><FormLabel>Taxi-In Time (mins)</FormLabel><FormControl><Input type="number" {...field} value={String(field.value ?? '')} onChange={e => field.onChange(parseInt(e.target.value, 10))} /></FormControl><FormMessage /></FormItem>)} />
                </div>
              ...
              <section className="space-y-4 p-4 border rounded-md shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-4 gap-y-3">
                  <FormField control={control} name="approaches" render={({ field }) => (<FormItem><FormLabel>Approaches</FormLabel><FormControl><Input type="number" {...field} value={String(field.value ?? '')} onChange={e => field.onChange(parseInt(e.target.value, 10))} /></FormControl><FormMessage /></FormItem>)} />
                  ...
                  <FormField control={control} name="dayLandings" render={({ field }) => (<FormItem><FormLabel>Day Landings</FormLabel><FormControl><Input type="number" {...field} value={String(field.value ?? '')} onChange={e => field.onChange(parseInt(e.target.value, 10))} /></FormControl><FormMessage /></FormItem>)} />
                  <FormField control={control} name="nightLandings" render={({ field }) => (<FormItem><FormLabel>Night Landings</FormLabel><FormControl><Input type="number" {...field} value={String(field.value ?? '')} onChange={e => field.onChange(parseInt(e.target.value, 10))} /></FormControl><FormMessage /></FormItem>)} />
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-3">
                  <FormField control={control} name="nightTimeDecimal" render={({ field }) => (<FormItem><FormLabel>Night Time (decimal)</FormLabel><FormControl><Input type="number" step="0.1" {...field} value={String(field.value ?? '')} onChange={e => field.onChange(parseFloat(e.target.value))} /></FormControl><FormMessage /></FormItem>)} />
                  <FormField control={control} name="instrumentTimeDecimal" render={({ field }) => (<FormItem><FormLabel>Instrument Time (decimal)</FormLabel><FormControl><Input type="number" step="0.1" {...field} value={String(field.value ?? '')} onChange={e => field.onChange(parseFloat(e.target.value))} /></FormControl><FormMessage /></FormItem>)} />
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-4 gap-y-3 items-end">
                  <FormField control={control} name="fobStartingFuel" render={({ field }) => (<FormItem><FormLabel>Starting Fuel (FOB)</FormLabel><FormControl><Input type="number" step="0.01" {...field} value={String(field.value ?? '')} onChange={e => field.onChange(parseFloat(e.target.value))} /></FormControl><FormMessage /></FormItem>)} />
                  <FormField control={control} name="fuelPurchasedAmount" render={({ field }) => (<FormItem><FormLabel>Fuel Purchased</FormLabel><FormControl><Input type="number" step="0.01" {...field} value={String(field.value ?? '')} onChange={e => field.onChange(parseFloat(e.target.value))} /></FormControl><FormMessage /></FormItem>)} />
                  ...
                  <FormField control={control} name="endingFuel" render={({ field }) => (<FormItem><FormLabel>Ending Fuel</FormLabel><FormControl><Input type="number" step="0.01" {...field} value={String(field.value ?? '')} onChange={e => field.onChange(parseFloat(e.target.value))} /></FormControl><FormMessage /></FormItem>)} />
                </div>
                 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-4 gap-y-3">
                    <FormField control={control} name="fuelCost" render={({ field }) => (<FormItem><FormLabel>Total Fuel Cost</FormLabel><FormControl><Input type="number" step="0.01" {...field} value={String(field.value ?? '')} onChange={e => field.onChange(parseFloat(e.target.value))} /></FormControl><FormMessage /></FormItem>)} />
                    <FormItem>
                    ...
                    <FormField control={control} name="postLegApuTimeDecimal" render={({ field }) => (<FormItem><FormLabel>Post-Leg APU Time</FormLabel><FormControl><Input type="number" step="0.1" {...field} value={String(field.value ?? '')} onChange={e => field.onChange(parseFloat(e.target.value))} /></FormControl><FormMessage /></FormItem>)} />
                 </div>
              </section>
            </form>
          </Form>
