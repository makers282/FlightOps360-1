...
import '@/ai/flows/manage-aircraft-rates-flow.ts'; // Added new aircraft rates flow
import '@/ai/flows/suggest-aircraft-performance-flow.ts'; // Added aircraft performance suggestion flow
