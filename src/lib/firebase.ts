...
if (app) {
  ...
  if (nodeEnv === 'development') {
      ...
      console.log("[Firebase Client Init] Emulator hosts: Auth (127.0.0.1:9100), Firestore (127.0.0.1:8080), Storage (127.0.0.1:9199)");
      
      try {
          // Check if already connected to avoid harmless "already connected" errors in Fast Refresh
          ...
          console.error('[Firebase Client Init ERROR] Connecting to Auth emulator:', e);
      }
      ...
      try {
          ...
          console.error('[Firebase Client Init ERROR] Connecting to Firestore emulator:', e);
      }
      ...
      try {
          ...
          console.error('[Firebase Client Init ERROR] Connecting to Storage emulator:', e);
      }
  } else {
