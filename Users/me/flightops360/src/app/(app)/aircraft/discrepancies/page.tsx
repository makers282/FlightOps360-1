...
"use client"; // Make this page component a client component directly

import React, { useState, useMemo, useEffect, useCallback, Suspense } from 'react'; // Added Suspense
...
function DiscrepanciesPageContent() { // Renamed original export to a local component
...
// It wraps the main content in a Suspense boundary.
export default function AllAircraftDiscrepanciesPage() {
  return (
    <Suspense fallback={
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)]">
        <Loader2 className="h-12 w-12 animate-spin text-primary" />
        <p className="mt-3 text-lg text-muted-foreground">Loading Discrepancies...</p>
      </div>
    }>
