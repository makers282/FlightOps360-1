...
export default function MaintenanceReportsPage() {
    ...
    const aircraftTableData = useMemo(() => {
        const dataMap = new Map<string, { totalCost: number; scheduledCost: number; unscheduledCost: number; tailNumber: string; }>();
        filteredCosts.forEach(cost => {
            const entry = dataMap.get(cost.aircraftId) || { totalCost: 0, scheduledCost: 0, unscheduledCost: 0, tailNumber: cost.tailNumber };
